  ...
  <div class="hello">
    ...
    <div class="center">
      ...
      <div class="floatLeft">
        <div class="total">
          ...
          <div class="totalCar">
            <div class="item">
              <div>路侧</div>
              <div class="num">{{ carDate.luce }}</div>
              <img src="../assets/images/图层 25.png" alt="" />
            </div>
            <div class="item">
              <div>场库</div>
              <div class="num">{{ carDate.chku }}</div>
              <img src="../assets/images/图层 25.png" alt="" />
            </div>
          </div>
          ...
          <div class="totalCar">
            <div class="item">
              <div>路侧</div>
              <div class="num">{{ carDate.lc }}</div>
              <img src="../assets/images/图层 26.png" alt="" />
            </div>
            <div class="item">
              <div>场库</div>
              <div class="num">{{ carDate.ck }}</div>
              <img src="../assets/images/图层 26.png" alt="" />
            </div>
          </div>
          <div class="group">
          ...
          <div class="outside">
            <div class="list" v-for="item in list" :key="item.zz">
              ...
              <div class="schedule">
                ...
                >
                  <div
                    class="today"
                    :style="`width:${(104.0 / 100) * item.ys}px`"
                  ></div>
                  <span style="margin-left: 8px">{{ item.ys.toFixed(1) }}</span>
                </div>
                <div
                  class="bottom"
                ...
                >
                  <div
                    class="thisWeek"
                    :style="`width:${(104.0 / 100) * item.zz}px`"
                  ></div>
              ...
              <div style="flex: 1">
                <span :style="{ color: item.sjl > 0 ? 'yellow' : 'green' }"
                  >{{ item.sjl }}%</span
                >
                <img
      ...
      <div class="floatCenter">
        <div class="number">
          <div style="color: #00c4fc; margin-right: 5px; font-weight: 600">
            总服务次数
          </div>
          <Flipper></Flipper>
          <!-- <span>1</span>
        ...
        <div class="money">
          <div style="color: #fff; margin-right: 5px; font-weight: 600">
            总收入金额
          </div>
          <Flippers></Flippers>
          <!-- <span>1</span>
      ...
      <div class="floatRight">
        <div class="total">
          ...
          <div class="carNum">车流量/车位占用率</div>
          <!-- 曲线图 -->
          <div id="curve"></div>
        </div>
      </div>
...
import Flippers from '@/components/Flippers.vue'
import axios from 'axios'
import { getTianqi, getWeather } from '../utils/api'
...
export default {
  ...
  methods: {
    getCar () {
      axios.get('/mock/car').then((res) => {
        console.log('333', res)
        this.carDate = res.data.data
        console.log(this.carDate, '99999')
        this.carDate = res.data.data
        console.log(this.carDate, '0000000')
        this.carDate.chku = res.data.data.chku
        this.carDate.ck = res.data.data.ck
        this.carDate.dd = res.data.data.dd
        this.carDate.fw = res.data.data.fw
        this.carDate.index = res.data.data.index
        this.carDate.lc = res.data.data.lc
        this.carDate.luce = res.data.data.luce
        this.carDate.sr = res.data.data.sr
        this.carDate.td = res.data.data.td
        this.list = res.data.data.yszz
    ...
    showTime () {
      ...
      const current = `${year}年${month}月${day}月 ${week} ${hour}:${minute}:${seconed}`
  ...
  created () {
    ...
    getWeather().then((res) => {
      ...
      var tem = res.data.lives[0].temperature
      console.log(tem, '111')
      var wea = res.data.lives[0].weather
      console.log(wea, '222')
      this.tianqi = wea + '' + tem
      console.log(this.tianqi, '000')
    })
    // this.initMap()
  },
  mounted () {
...
.hello {
  ...
  .center {
    ...
    height: 55.3125rem;
    z-index: 1;
    background: url("../assets/images/图层 1.png") 120% 0% no-repeat;
    .floatLeft {
      width: 27.6875rem;
      height: 885px;
      float: left;
